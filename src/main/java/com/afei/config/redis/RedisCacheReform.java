...
//
//public class RedisCacheReform extends AbstractValueAdaptingCache {
//
...
//
//    /**
//     * Constructs a new {@link RedisCacheReform} instance.
//     *
...
//     * @param expiration
//     */
//    public RedisCacheReform(String name, byte[] prefix, RedisOperations<? extends Object, ? extends Object> redisOperations,
//                            long expiration) {
...
//
//    /**
//     * Metadata required to maintain {@link RedisCacheReform}. Keeps track of additional data structures required for processing
//     * cache operations.
//     *
...
//
//        /**
//         * @return true if the {@link RedisCacheReform} uses a prefix for key ranges.
//         */
...
//        private final RedisCacheMetadata metadata;
//        private final String startCursor = "0";
//
...
//                }
//            } else {
//                Object c = connection.getNativeConnection();
//                if (c instanceof Jedis) {
//                    redisCacheCleanByJedis(c, prefixToUse);
//                } else {
...
//        }
//
//        protected void redisCacheCleanByJedis(Object connection, byte[] prefixToUse) {
//            Jedis jedis = (Jedis) connection;
//            ScanParams scanParams = new ScanParams();
//            scanParams.count(10000);
//            scanParams.match(prefixToUse);
//            String start = startCursor;
//            List<String> keys = new ArrayList<>();
//            while (true) {
//                ScanResult<String> scanResult = jedis.scan(start, scanParams);
//                keys.addAll(scanResult.getResult());
//                start = scanResult.getStringCursor();
//                if (startCursor.equals(start)) {
//                    break;
//                }
//            }
//            if (keys.size() == 0) {
